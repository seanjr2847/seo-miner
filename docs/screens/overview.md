...
- **기회 한 건을 펼치면** — 맨 위에 행동 줄 한 줄(「요청문 만들기」·**지금 상태 칩**·상태
  버튼·도구로 열기·「○○ 화면에서 자세히 보기」가 한 줄에 섭니다. 접힌 줄이 「할 일」일 때
  상태 배지를 안 다는 대신, 지금이 어디인지는 이 칩이 말합니다), 그 아래로
  묶인 검색어 표(검색어·월 검색량·점수·상태와 묶은 이유),
...
<!-- 근거:
  ...
  skills/capture/templates/dashboard.html:1120-1131 (레일: 사이트·기준 수집일·새로고침),
    ...
    2010-2016 (gaBadge), 2026-2038 (madeBadge),
    2061-2105 (OPP_NEXT/OPP_SET/oppBtn/oppActs/oppNow(지금 상태 칩)/oppRest/oppPanel(o, extra)),
