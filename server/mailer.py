...
def run_done(to: str, project: str, stats: dict) -> bool:
    ...
    html = (
        ...
        'font-weight:bold;color:#22705F;">측정이 끝났습니다</td></tr>'
...
def demo() -> None:
    ...
    try:
        ...
        assert body["subject"] == "테스트 프로젝트 측정이 끝났습니다", (
